...
function Content() {
  ...
  const totalTasks = specs.reduce(
    (acc, s) => acc + (s.taskProgress?.total || 0),
    0
  );
  const completedTasks = specs.reduce(
    (acc, s) => acc + (s.taskProgress?.completed || 0),
    0
  );
  ...
  const taskSummary =
    totalSpecs > 0
      ? `${totalTasks} tasks across ${totalSpecs} spec${
          totalSpecs === 1 ? "" : "s"
        }`
      : "No active specs";
      ...
      <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8">
        <div className="text-center">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 max-w-sm mx-auto mb-6">
            We're working on additional analytics and insights for your
            development workflow. Stay tuned for updates!
          </p>

          <div className="flex items-center justify-center gap-4">
            <a
              href="https://github.com/Uniswap/spec-workflow-mcp/pkgs/npm/spec-workflow-mcp"
              target="_blank"
            ...
            <a
              href="https://github.com/uniswap/spec-workflow-mcp"
              target="_blank"
              rel="noopener noreferrer"
